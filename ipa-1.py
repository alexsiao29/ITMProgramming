...
def savings(gross_pay, tax_rate, expenses):
    ...
    after_tax=(gross_pay-(tax_rate*gross_pay))//1
    result=after_tax-expenses
    return int(result)

savings(30000, 0.3, 200)
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    result0=total_material-consumed_material
    return str(int(result0))+ str(material_units)

material_waste(3000,"kg",20,15)
